...
2. [ ] **Check MACP inbox** (`/macp-inbox` or `macp_read_messages`)
3. [ ] Check SERVER_STATUS.md for current deployment status
4. [ ] Check CHANGELOG.md for recent changes
5. [ ] Check GitHub issues in PRIVATE repo for pending CTO reviews
6. [ ] Read latest session handoff in `iteration/Session_Handoff_*.md`
